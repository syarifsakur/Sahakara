...
const Main2 = () => {
  return (
    <div className=" h-lvh mx-10 my-20 poppins ">
      <h1 className="flex justify-center text-xl lg:text-4xl text-blue-950 font-bold">
        Kenapa Memilih Lucky Futsal?
      </h1>
      <div className="flex justify-between mt-20">
        <div className="flex lg:flex-wrap lg:max-w-2xl gap-2 lg:gap-6 ">
        ...
        <div className="max-w-40 lg:max-w-[550px] w-[900px] text-sm sm:text-lg text-blue-950 lg:text-2xl flex flex-col justify-between">
          ...
          <Button
            className=" bg-blue-950 mt-10 md:mt-20 h-8 md:h-10 lg:h-12 w-40 lg:w-56 text-xs md:text-sm lg:text-lg hover:bg-blue-700 ml-44"
