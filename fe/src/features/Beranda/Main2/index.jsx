...
const Main2 = () => {
  return (
    <div className=" h-lvh mx-10 mt-20 poppins ">
        <h1 className="flex justify-center text-xl lg:text-5xl text-blue-950 font-bold">Kenapa Memilih Lucky Futsal?</h1>
        <div className="flex justify-between mt-20 ">
            <div className="flex lg:flex-wrap lg:max-w-3xl gap-2 lg:gap-16 ">
            ...
            <div className="max-w-40 lg:max-w-[650px] w-[900px] text-sm sm:text-lg text-blue-950 lg:text-3xl flex flex-col justify-between">
                ...
                <Button  className=" bg-blue-950 mt-10 md:mt-20 h-8 md:h-10 lg:h-14 w-40 lg:w-56 text-xs md:text-sm lg:text-xl hover:bg-blue-700 ml-48" text="Booking Sekarang" ></Button>
            </div>
        </div>
    </div>
  )
