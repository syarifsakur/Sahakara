  ...
  return (
    <>
      <div className="flex bg-blue-950 z-10 sticky top-0 right-0 shadow-xl">
        <div className="w-full mx-10 h-10 lg:h-20 text-white poppins font-bold text-3xl flex items-center justify-between">
          <div className="flex items-center gap-x-2">
            <img src={logo} alt="logo" className="h-6 md:h-10 lg:h-[50px] sm:h-8" />
            <h1 className="text-xs lg:text-3xl md:text-2xl sm:text-sm">Lucky Futsal</h1>
          </div>
